function [net accuracy] = mlp_hu_free(TrainingData, nhidden,ActivationFunction)
...
net.w2=OutputWeight;
net.b2=0;
pre_accuracy=obj(OutputWeight,H,TargetData);%B: The resulted output matrix %H: The temporary hidden matrix with dimension N*nhidden % T: Targets from demonstrations with dimension N*d
